...
def get_madrid_weather():
    """Obtiene el clima actual en Madrid usando wttr.in (sin límite de API)."""
...
def get_madrid_traffic():
    ...
    # Bounding box para Madrid Área Metropolitana (Incluye M-40, M-50, A-6, etc.)
    # minLat,minLon,maxLat,maxLon
    bbox = "40.250,-3.950,40.550,-3.450"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if not incidents:
                return "🚗 *Tráfico en Madrid:*\nNo se reportan incidencias graves en el área metropolitana."
            
            return f"🚗 *Tráfico en Madrid:*\nActualmente hay {len(incidents)} incidencias reportadas en el área metropolitana (M-30, M-40, M-50)."
